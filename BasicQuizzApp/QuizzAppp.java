/**
 * QuizzAppp - A Simple Quiz Application
 * 
 * This application presents a quiz with multiple-choice questions. Users can answer questions, use
 * helplines for assistance, and receive detailed solutions at the end of the quiz.
 * 
 * Author: Meetkumar Chavda
 * Email: meetkumar.chavda785@gmail.com
 * 
 * The quiz includes 10 questions on various topics, each with four answer options. Users have
 * access to four helplines:
 * 1. Reduce Options - Eliminates two incorrect options.
 * 2. Show Correct Answer - Displays the correct answer.
 * 3. Call a Friend -(prank/gimmick) Provides a simulated response from a friend.
 * 4. Hint - Gives a hint about the correct answer.
 * 
 * Usage:
 * - Run the program to start the quiz.
 * - Answer each question by selecting an option or using a helpline.
 * - At the end of the quiz, review your performance and detailed solutions.
 * 
 ...
 * 3. Run the compiled class file to start the quiz.
 * 
 * Note:
 * - The quiz is designed to be simple and educational.
 * - The code is structured for clarity and ease of understanding.
 * 
 * Feel free to contribute or provide feedback on this project.
 */
package BasicQuizzApp;

import java.util.*;

/**
 * BasicQuizzApp is a console-based quiz application in Java.
 * It allows users to answer multiple-choice questions and use various
 * helplines.
 * The app provides feedback based on the user's performance and detailed
...
class QuizzAppp {
	...
	/**
	 * Starts the quiz, processes user answers, and manages helplines.
	 */
	...
	/**
	 * Prints the question and options. Depending on helplines used, it might show
	 * reduced options, correct answer, or hints.
	 * 
	 * @param questionCount Index of the current question
	 */
	...
	/**
	 * Validates the user's answer input.
	 * 
	 * @param temp User's input
	...
	/**
	 * Displays available helplines and calls the helpline selection method.
	 * 
	 * @param questionCount Index of the current question
	 */
	...
	/**
	 * Handles the selection of a helpline and its execution.
	 * 
	 * @param questionCount Index of the current question
	 */
	...
	/**
	 * Validates if the helpline choice is one of the available options.
	 * 
	 * @return true if the helpline choice is invalid; false otherwise
	 */
	...
	/**
	 * Boolean flags for controlling the state of helpline features.
	 */
	static boolean reduceOptionsMagic = false;// Indicates if the "Reduce Options" helpline is active.
	static boolean correctAnsMagic = false; // Indicates if the "Show Correct Answer" helpline is active.
	static boolean hintMagic = false; // Indicates if the "Hint" helpline is active.

	/**
	 * Executes the selected helpline based on the user's choice.
	 * This method updates the state of helplines and performs actions
	 * based on the selected helpline.
	 * 
	 * @param questionCount Index of the current question for which the helpline is
	 *                      being used.
	 */
	...
	/**
	 * Displays the user's results and feedback.
	 */
